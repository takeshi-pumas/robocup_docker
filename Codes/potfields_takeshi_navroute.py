...
def readSensor(data):
     ...
     euler=euler_from_quaternion(rot_odom)
     th=euler[2]
     x,y =trans_odom[0],trans_odom[1]
     #markerstopub= MarkerArray()
...
def inoutinout():
    ...
    while not rospy.is_shutdown():
        ...
        try:
            (trans_odom,rot_odom) = tf_listener.lookupTransform('/map', '/base_footprint', rospy.Time(0))
            #print (trans,rot)
